...
B_Pawn = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\B_Pawn.png").convert_alpha()
B_King = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\B_King.png").convert_alpha()
B_Queen = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\B_Queen.png").convert_alpha()
B_Knight = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\B_Knight.png").convert_alpha()
B_Bishop = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\B_Bishop.png").convert_alpha()
B_Rook = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\B_Rook.png").convert_alpha()

W_Pawn = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\W_Pawn.png").convert_alpha()
W_Bishop = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\W_Bishop.png").convert_alpha()
W_King = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\W_King.png").convert_alpha()
W_Knight = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\W_Knight.png").convert_alpha()
W_Queen = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\W_Queen.png").convert_alpha()
W_Rook = pygame.image.load("C:\\Users\\NAME\\Downloads\\ChessPieces\\W_Rook.png").convert_alpha()
